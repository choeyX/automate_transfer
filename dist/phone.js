...
exports.PhoneAutomation = void 0;
const automation_1 = require("./automation");
class PhoneAutomation extends automation_1.AndroidAutomation {
    // Debug method to show available elements
    static async debugDialpad() {
    ...
    static async callContact(contactName) {
...
exports.PhoneAutomation = PhoneAutomation;
